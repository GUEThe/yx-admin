    ...
    <el-container>
      <el-main>
        ...
        <el-table v-loading="listLoading" :data="listData" element-loading-text="正在加载..." border fit
          ...
          <el-table-column label="报道人数" align="center" prop="amount"></el-table-column>
        </el-table>
...
import PieChart from '../components/ComePie.vue';
...
export default class Come extends Vue {
  listLoading: boolean = false;
  listData: any[] = [
    { campus: '花江校区', college: '机电', major: '机电工程', amount: '320' },
    { campus: '花江校区', college: '通信', major: '通信工程', amount: '240' },
    { campus: '花江校区', college: '计算机', major: '计算机工程', amount: '149' },
    { campus: '花江校区', college: '商学院', major: '会计学', amount: '100' },
    { campus: '花江校区', college: '外国语', major: '外语专业', amount: '59' },
    { campus: '花江校区', college: '艺术学院', major: '艺术', amount: '100' },
    { campus: '花江校区', college: '数学', major: '数学', amount: '59' }
  ];
