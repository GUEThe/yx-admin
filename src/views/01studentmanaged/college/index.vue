<template>
  <div style="padding:5px">
    <el-container>
      <el-main>
        <h3>学院管理</h3>
        <el-button type="primary" icon="el-icon-plus" size="mini" @click="onEditCollege(0)">
          新增学院
        </el-button>
        <el-table v-loading="listLoading" :data="
          ...
          <el-table-column align="center" width="400">
            ...
            <template slot-scope="scope">
              <el-button-group>
                <el-button type="primary" size="mini" @click="onEditCollege(scope.row.id, 1)">
                  编辑
                </el-button>
...
export default class College extends Vue {
  ...
  async getCollegeAsync(page: number = 1) {
    ...
    const { data, total } = await api.GetCollegeList()
    console.log(data)
    this.listData = data!
    this.total = total!
