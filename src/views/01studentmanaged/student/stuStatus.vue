<template>
  <el-dialog width="330px" title="更新学籍状态" :visible="showDialog" destroy-on-close
    ...
    <el-form :model="newStuInfo" label-width="80px">
      <el-form-item label="姓名">
        <el-input v-model="newStuInfo.name" disabled></el-input>
      </el-form-item>
      <el-form-item label="学号">
        <el-input v-model="newStuInfo.studentId" disabled></el-input>
      </el-form-item>

      <!-- 是否在校字段 -->
      <el-form-item label="是否在校">
        <el-select v-model="newStuInfo.changetype" placeholder="选择是否在校">
      ...
      <el-form-item label="学籍状态">
        <el-select v-model="newStuInfo.stustatus" placeholder="选择学籍状态">
...
export default class StuStatus extends Vue {
  ...
  newStuInfo: models.StuInfo | Object = {};
  ...
  init() {
    this.newStuInfo = deepClone(this.stuInfo)
  }
